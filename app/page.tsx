...
export default function Home() {
  ...
  return (<div className="min-h-screen bg-gray-50 flex flex-col font-sans relative"> {
    ...
    > <a href="tel:0778525115"className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all hover:scale-105 tracking-wide"> <PhoneIcon className="mr-2 -ml-1 h-5 w-5"/> Call Now </a> </motion.div> {
      /* Mobile Buttons (Call + Menu) */
    }

    <div className="flex items-center space-x-2 md:hidden"> <a href="tel:0778525115"className="inline-flex items-center justify-center p-2 rounded-md text-blue-600 bg-blue-50 border border-blue-100 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500"> <span className="sr-only">Call Now</span> <PhoneIcon className="h-5 w-5"aria-hidden="true"/> </a> <button type="button"
