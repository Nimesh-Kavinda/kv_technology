  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans relative">
      ...
      <header className="bg-white shadow-sm border-b border-gray-200 relative z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            >
              <Link href="#" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 border-b-2 px-1 pt-1 text-sm font-medium transition-colors">Home</Link>
              <Link href="#services" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 border-b-2 px-1 pt-1 text-sm font-medium transition-colors">Repair Services</Link>
              <Link href="#accessories" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 border-b-2 px-1 pt-1 text-sm font-medium transition-colors">Accessories</Link>
              <Link href="#contact" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 border-b-2 px-1 pt-1 text-sm font-medium transition-colors">Contact Us</Link>
            </motion.nav>
            ...
            >
              <a href="tel:0778525115" className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all hover:scale-105 tracking-wide">
      ...
      <main className="flex-grow">
        ...
        <div className="relative bg-gray-900 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                <a href="#services" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-gray-900 bg-white hover:bg-gray-50 shadow-sm transition-all hover:scale-105">
                  View Services
                </a>
                <a href="tel:0778525115" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 shadow-sm transition-all hover:scale-105">
                  Call Us Now
                </a>
              </motion.div>
            </motion.div>
        ...
        <div className="bg-white py-12 border-b border-gray-100 relative z-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div 
              initial="hidden"
              whileInView="visible"
            ...
            >
              <motion.div variants={fadeInUp} className="flex flex-col items-center p-4">
                <div className="flex items-center justify-center h-16 w-16 rounded-full bg-blue-100 text-blue-600 mb-4 transition-transform hover:scale-110">
        ...
        <div id="services" className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          ...
          >
            {/* Mobile Phones */}
            <motion.div variants={scaleIn} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100 flex flex-col group hover:-translate-y-2">
        ...
        <div id="accessories" className="bg-gray-100 py-16 px-4 sm:py-24 sm:px-6 lg:px-8 border-t border-gray-200">
          <div className="max-w-7xl mx-auto">
            ...
            >
              {/* Chargers */}
              <motion.div variants={fadeInUp} className="group relative bg-white rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-300 border border-gray-100">
          ...
          >
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li className="flex items-start">
                ...
                <a href="mailto:nimeshkavindakarunasinghe@gmail.com" className="hover:text-white break-all hover:underline">nimeshkavindakarunasinghe@gmail.com</a>
              </li>
              <li className="flex items-start">
